...
class test_avain_generoija(unittest.TestCase):
    def setUp(self):
        ...
        self.avaingeneroija.eka_alkuluku = 13
        self.avaingeneroija.toka_alkuluku = 7
        self.avaingeneroija.alkulukujen_tulo = 91
        self.avaingeneroija.euler = 72
    ...
    def test_eulerin_pii_funktio_toimii(self):
        ...
        self.assertEqual(eulerin_pii, 72)
    ...
    def test_julkinen_eksponentti_oikein(self):
